        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/abhinavs1703" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/abhinavsrivastava1703/" },
                { icon: Twitter, href: "https://x.com/Abhinav24546520" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
